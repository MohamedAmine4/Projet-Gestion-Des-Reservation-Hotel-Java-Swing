...
public class Login extends JFrame {
	...
	public Login() {
		...
		textField.setMargin(new Insets(0, 80, 0, 0));
		...
		passwordField.setMargin(new Insets(0, 80, 0, 0));
		passwordField.setBounds(120, 164, 229, 33);
		panel_2.add(passwordField);
		
		JLabel lblNewLabel_3 = new JLabel("New label");
		lblNewLabel_3.setIcon(new ImageIcon(Login.class.getResource("1.png.png")));
		lblNewLabel_3.setBounds(401,0, 282, 421);
		contentPane.add(lblNewLabel_3);
		
		ImageIcon im=new ImageIcon(Login.class.getResource("1.png.png"));
	...
	public void connecter(ActionEvent e) {
	    ...
	    if(us.isEmpty() ||  pwd.length == 0 ) {
	        ...
	        if(us.equals("Agent") && pwdStr.equals("agent123")) {
	            JOptionPane.showMessageDialog(null, "Bienvenue, cher Agent ! Vous êtes maintenant connecté.");
	            
	            new InterfacePrincipaleAgent();
	            f.setVisible(false);
	            
	        } else if(us.equals("Admin") && pwdStr.equals("admin123")) {
	            JOptionPane.showMessageDialog(null, "Bienvenue, cher Administrateur ! Vous êtes maintenant connecté.");
